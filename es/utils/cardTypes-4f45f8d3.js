...
var CARD_TYPES = [
  ...
  },
  {
    ...
    format: DEFAULT_CARD_FORMAT,
    startPattern:
      /^(5[1-5]|677189|223115)|^(222[1-9]|2[3-6]\d{2}|27[0-1]\d|2720)/,
    gaps: [4, 8, 12],
    lengths: [16],
    code: {
      name: "CVC",
...
export {
  getCardTypeByValue as a,
  cardTypes as b,
  DEFAULT_CVC_LENGTH as c,
  DEFAULT_ZIP_LENGTH as d,
  DEFAULT_CARD_FORMAT as e,
  CARD_TYPES as f,
  getCardTypeByType as g,
};
